...
function resetCards() {
  $.get('http://ec2-52-89-83-246.us-west-2.compute.amazonaws.com:3000/player/player2', function (data) {
    currentHand = [];
...
function updateCards(curr, left) {
  ...
  if (gamePlayers === 2) nextPlayer = 'player1';
  if (gamePlayers > 2) nextPlayer = 'player3';
  $.ajax({
  ...
  $.ajax({
    url: 'http://ec2-52-89-83-246.us-west-2.compute.amazonaws.com:3000/player/player2',
    type: "PUT",
    data: sendCards(leftovers, 'player2', '', '', ''),
    dataType: "json",
    contentType: "application/json"
  });
}
